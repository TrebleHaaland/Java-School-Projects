...
public class EventSchedule {
	...
	public EventSchedule() {
		...
		System.out.println("EventSchedule(int, int, int) was called" + "EventSchedule() was called");
	}
	...
	public EventSchedule(int year) {
		...
		System.out.println("EventSchedule(int, int, int) was called " + " EventSchedule() was called" + " EventSchedule(int) was called");
        System.out.println();
        this.year = year;
	}
	...
	public EventSchedule(int year, int month) {
        System.out.println("EventSchedule(int, int, int) was called" + "  EventSchedule() was called" + "  EventSchedule(int, int) was called" );
        System.out.println();
        this.year = year;
        this.month = month;
    }
